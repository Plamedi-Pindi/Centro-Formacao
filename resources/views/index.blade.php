@extends('layouts.merges.HomeMerge')
    ...
    <div class="page-content bg-white">
                ...
                <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                    <ul> <!-- SLIDE  -->
                        <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="Site/images/slider/slide3.jpg" alt="" data-bgposition="center center"
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-100-layer-3"
                                ...
                                MELHOR EDUCAÇÃO PARA UMA CARREIRA MELHOR
                            </div>
                        ...
                        <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default"
                            ...
                            data-easeout="default" data-masterspeed="default" data-thumb="Site/images/slider/slide1.jpg"
                            ...
                            data-description="Science says that Women are generally happier">
                            <!-- MAIN IMAGE -->
                            <img src="Site/images/slider/slide4.jpg" alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                data-no-retina />
        ...
        <div class="content-block">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img src="Site/images/our-services/pic4.jpg" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    ...
                                    <a href="#" class="btn radius-xl">Saiba Mais</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6">
                            <div class="service-bx">
                                <div class="action-box">
                                    <img src="Site/images/our-services/pic5.jpg" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                                        <i class="fa fa-lock text-primary"></i>
                                    </div>
                                    <h4><a href="#">Cibersegurança</a></h4>
                                    <a href="#" class="btn radius-xl">Saiba Mais</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="service-bx m-b0">
                                <div class="action-box">
                                    <img src="Site/images/our-services/pic6.jpg" alt="">
                                </div>
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            ...
                            <p>Conheça os cursos mais solicitados pelos alunos.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="Site/images/courses/pic10.jpg" alt="">
                                        <a href="#" class="btn">Leia Mais</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Computação em Nuvem </a></h5>
                                        <span>Online</span>
                                    </div>
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="Site/images/courses/pic11.webp" alt="">
                                        <a href="#" class="btn">Leia Mais</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#"> Cibersegurança</a></h5>
                                        <span>Online</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="Site/images/courses/pic12.webp" alt="">
                                        <a href="#" class="btn">Leia Mais</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Arquitetura de Dados</a></h5>
                                        <span>Online</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
                            ...
                            <div class="item">
                                <div class="cours-bx">
                                    <div class="action-box">
                                        <img src="Site/images/courses/pic13.jpg" alt="">
                                        <a href="#" class="btn">Leia Mais</a>
                                    </div>
                                    <div class="info-bx text-center">
                                        <h5><a href="#">Rede de Computadores</a></h5>
                                        <span>Online</span>
                                    </div>
                                    <div class="cours-more-info">
                                        <div class="review">
            ...
            <div class="section-area section-sp1 ovpr-dark bg-fix online-cours"
                style="background-image:url(Site/images/background/bg1.webp);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center text-white">
                            <h2>Cursos On-line para Aprender</h2>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="cours-search-bx m-b30">
                                    ...
                                    <span class="cours-search-text">Mais de 5 milhões de estudantes</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="cours-search-bx m-b30">
                                    ...
                                    <span class="cours-search-text">30,000 Cursos.</span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="cours-search-bx m-b30">
                                    ...
                                    <span class="cours-search-text">Aprenda Tudo On-line.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center heading-bx">
                            ...
                            <p class="m-b0">Próximos Eventos Educacionais para Libertar o Cérebro. </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="Site/images/event/pic11.webp" alt="">
                                    </div>
                            ...
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="Site/images/event/pic10.jpg" alt="">
                                    </div>
                                    <div class="info-bx d-flex">
                                        <div>
                                            <div class="event-time">
                            ...
                            <div class="item">
                                <div class="event-bx">
                                    <div class="action-box">
                                        <img src="Site/images/event/pic2.jpg" alt="">
                                    </div>
                                    <div class="info-bx d-flex">
                                        <div>
                                            <div class="event-time">
                    ...
                    <div class="text-center">
                        <a href="#" class="btn">Ver Todos os Eventos</a>
                    </div>
                </div>
            </div>
            ...
            <div class="section-area section-sp2 bg-fix ovbl-dark"
                style="background-image:url(Site/images/background/bg2.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-white heading-bx left">
                            <h2 class="title-head text-uppercase">O que as pessoas <span>dizem</span></h2>
                            <p>Testemunho de alguns estudantes.</p>
                        </div>
                    </div>
                    <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        <div class="item">
                            <div class="testimonial-bx">
                                <div class="testimonial-thumb">
                                    <img src="Site/images/testimonials/pic1.jpg" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="testimonial-bx">
                                <div class="testimonial-thumb">
                                    <img src="Site/images/testimonials/pic2.jpg" alt="">
                                </div>
                                <div class="testimonial-info">
                                    <h5 class="name">Peter Packer</h5>
                                    <p>-Art Director</p>
            ...
            <div class="section-area section-sp2">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 heading-bx left">
                            <h2 class="title-head">Notícias <span>Recentes</span></h2>
                            <p>Esteja a par de tudo o que tem acontecido.</p>
                        </div>
                    </div>
