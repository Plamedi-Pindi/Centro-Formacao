            ...
            <div class="col-lg-12 m-b30">
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        <form action="{{ route('admin.atualizaraluno',  $aluno->id) }}" method="POST" class="edit-profile m-b30">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control" type="text" name="name" value="{{ $aluno->name }}" required>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <select name="gender" id="gender" required>
                                            <option active>{{ $aluno->genero }}</option>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div>
                                        <input class="form-control" type="text" name="email" value="{{ $aluno->email }}" required>
                                    </div>
                                </div>
                                <div class="form-group col-6">
                                    <label class="col-form-label">Telefone</label>
                                    <div>
                                        <input class="form-control" type="text" name="phone" value="{{ $aluno->telefone }}" required>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        ...
                                                        <div>
                                                            <input class="form-control" type="password" required name="password" value="{{ $aluno->password }}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label class="col-form-label">Confirmar Senha</label>
                                                        <div>
                                                            <input class="form-control" type="password" required name="confPassword" value="{{ $aluno->password }}">
                                                        </div>
                                                    </div>
