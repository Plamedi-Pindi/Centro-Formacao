		...
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-logo-box">
				<div>
					{{-- <a href="index.html" class="ttr-logo">
						<img class="ttr-logo-mobile" alt="" src="/Admin/images/logo-mobile.png" width="30" height="30">
						<img class="ttr-logo-desktop" alt="" src="/Admin/images/logo-white.png" width="160" height="27">
					</a> --}}
				</div>
			</div>
			<!--logo end -->
			<div class="ttr-header-menu">
				...
				<ul class="ttr-header-navigation">
					<li>
						<a href="{{ route('site.home') }}" class="ttr-material-button ttr-submenu-toggle">HOME</a>
					</li>
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<ul class="ttr-header-navigation">
					...
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="/Admin/images/testimonials/pic3.jpg" width="32" height="32"></span></a>
						<div class="ttr-header-submenu">
							<ul>
								<li><a href="user-profile.html">Meu Perfil</a></li>

								<li>
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <input type="submit" value="Sair" id="" class="logout-input">
                                    </form>
                                </li>
							</ul>
						</div>
